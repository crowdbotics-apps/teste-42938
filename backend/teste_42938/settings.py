"""
Django settings for teste_42938 project.
...
WSGI_APPLICATION = 'teste_42938.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "teste_42938 API",
    "DESCRIPTION": "API documentation for teste_42938 App",
    "VERSION": "v1",
}
